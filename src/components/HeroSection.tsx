...
const HeroSection = () => {
  return (
    <div className="relative min-h-[90vh] w-full flex flex-col justify-center items-center px-4 bg-gradient-to-b from-gray-900 to-gray-800">
      <div className="z-10 max-w-4xl mx-auto text-center md:text-left md:flex md:items-center md:space-x-12">
        ...
        <div className="w-64 h-64 mx-auto md:mx-0 mb-8 md:mb-0 relative">
          <div className="w-full h-full rounded-full bg-gradient-to-br from-blue-500/20 to-blue-700/40 flex items-center justify-center overflow-hidden border-4 border-blue-500/20">
        ...
        <div className="md:flex-1">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">
            Senior UI/UX Designer with Product Strategy Focus
          </h1>
          
          {/* Brief Professional Introduction */}
          <p className="text-xl mb-8 text-gray-300 max-w-2xl">
            With 8+ years of experience designing for fintech, healthcare, and enterprise platforms, I transform complex problems into intuitive digital experiences that drive measurable business results.
          </p>
