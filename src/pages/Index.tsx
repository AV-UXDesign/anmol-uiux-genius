    ...
    <div className="min-h-screen bg-black text-white relative">
      ...
      <div className="fixed inset-0 overflow-hidden z-0">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
          ...
          <svg className="absolute top-10 left-10 w-96 h-96 opacity-10" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            <path fill="#3B82F6" d="M44.7,-76.4C58.9,-69.9,71.7,-59.5,79.4,-45.9C87.1,-32.3,89.8,-16.1,88.2,-0.9C86.7,14.3,81,28.6,73.1,41.4C65.3,54.2,55.4,65.5,42.8,73.2C30.2,80.9,15.1,85,0.2,84.7C-14.8,84.4,-29.6,79.8,-42.2,71.9C-54.8,64,-65.2,52.7,-73.3,39.5C-81.4,26.2,-87.2,13.1,-86.8,0.2C-86.4,-12.7,-79.8,-25.3,-71.6,-37C-63.4,-48.7,-53.6,-59.3,-41.5,-66.8C-29.4,-74.3,-14.7,-78.6,0.6,-79.7C16,-80.7,32,-82.9,44.7,-76.4Z" transform="translate(100 100)" />
          </svg>
          
          <svg className="absolute bottom-10 right-20 w-80 h-80 opacity-10" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg className="absolute top-1/2 right-1/4 w-64 h-64 opacity-5" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Design process background - now applied globally */}
        <div className="absolute inset-0 bg-gradient-to-b from-black via-blue-950/20 to-black opacity-60"></div>
